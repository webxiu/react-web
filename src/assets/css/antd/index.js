...
module.exports = {
  ...
  '@tabs-highlight-color': '#f1f1f1',
  '@tabs-hover-color': '#f1f1f1',
  '@tabs-active-color': '#f1f1f1',

  '@tree-bg': 'transparent',
  '@tree-directory-selected-color': '#333',
  '@tree-directory-selected-bg': 'transparent',
  '@tree-node-hover-bg': '#424242',
  '@tree-node-selected-bg': '#424242'
};
