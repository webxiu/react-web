...
import axiosInstance, { AppAxiosRequestConfig, AxiosRequestConfig, InjectAbort } from '@/axios';
...
export const GetWaitAnalysisDocumentNumApi = (request: GetWaitAnalysisDocumentNumApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<GetWaitAnalysisDocumentNumApi$$Response>>(
    '/v1/GetWaitAnalysisDocumentNumApi',
    request,
    InjectAbort(GetWaitAnalysisDocumentNumApi, config)
  );
};
...
export const BatchDeleteDocumentApi = (request: BatchDeleteDocumentApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<BatchDeleteDocumentApi$$Response>>(
    '/v1/BatchDeleteDocumentApi',
    request,
    InjectAbort(BatchDeleteDocumentApi, config)
  );
};
...
export const ListDocumentPeopleApi = (request: ListDocumentPeopleApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<ListDocumentPeopleApi$$Response>>(
    '/v1/ListDocumentPeopleApi',
    request,
    InjectAbort(ListDocumentPeopleApi, config)
  );
};
...
export const ListPeopleDocumentApi = (request: ListPeopleDocumentApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<ListPeopleDocumentApi$$Response>>(
    '/v1/ListPeopleDocumentApi',
    request,
    InjectAbort(ListPeopleDocumentApi, config)
  );
};
...
export const PeopleDocumentAnalysisApi = (request: PeopleDocumentAnalysisApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<PeopleDocumentAnalysisApi$$Response>>(
    '/v1/PeopleDocumentAnalysisApi',
    request,
    InjectAbort(PeopleDocumentAnalysisApi, config)
  );
};
...
export const PeopleRelationDiagramApi = (request: PeopleRelationDiagramApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<PeopleRelationDiagramApi$$Response>>(
    '/v1/PeopleRelationDiagramApi',
    request,
    InjectAbort(PeopleRelationDiagramApi, config)
  );
};
...
export const PeopleRelationExternalApi = (request: PeopleRelationExternalApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<PeopleRelationExternalApi$$Response>>(
    '/v1/PeopleRelationExternalApi',
    request,
    InjectAbort(PeopleRelationExternalApi, config)
  );
};
...
export const DocumentPeopleCountApi = (request: DocumentPeopleCountApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<DocumentPeopleCountApi$$Response>>(
    '/v1/DocumentPeopleCountApi',
    request,
    InjectAbort(DocumentPeopleCountApi, config)
  );
};
...
export const PeopleAddressCountApi = (request: PeopleAddressCountApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<PeopleAddressCountApi$$Response>>(
    '/v1/PeopleAddressCountApi',
    request,
    InjectAbort(PeopleAddressCountApi, config)
  );
};
...
export const UploadDocumentTrendApi = (request: UploadDocumentTrendApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<UploadDocumentTrendApi$$Response>>(
    '/v1/UploadDocumentTrendApi',
    request,
    InjectAbort(UploadDocumentTrendApi, config)
  );
};
...
export const AdminAllocateTaskApi = (request: AdminAllocateTaskApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<AdminAllocateTaskApi$$Response>>(
    '/v1/task/AdminAllocateTaskApi',
    request,
    InjectAbort(AdminAllocateTaskApi, config)
  );
};
...
export const AuditorStatisticsApi = (request: AuditorStatisticsApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<AuditorStatisticsApi$$Response>>(
    '/v1/task/AuditorStatisticsApi',
    request,
    InjectAbort(AuditorStatisticsApi, config)
  );
};
...
export const AuditorAllocateTaskApi = (request: AuditorAllocateTaskApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<AuditorAllocateTaskApi$$Response>>(
    '/v1/task/AuditorAllocateTaskApi',
    request,
    InjectAbort(AuditorAllocateTaskApi, config)
  );
};
...
export const AuditorAuditTaskApi = (request: AuditorAuditTaskApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<AuditorAuditTaskApi$$Response>>(
    '/v1/task/AuditorAuditTaskApi',
    request,
    InjectAbort(AuditorAuditTaskApi, config)
  );
};
...
export const AuditorNoPassTaskApi = (request: AuditorNoPassTaskApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<AuditorNoPassTaskApi$$Response>>(
    '/v1/task/AuditorNoPassTaskApi',
    request,
    InjectAbort(AuditorNoPassTaskApi, config)
  );
};
...
export const ListAllocatedPeopleApi = (request: ListAllocatedPeopleApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<ListAllocatedPeopleApi$$Response>>(
    '/v1/task/ListAllocatedPeopleApi',
    request,
    InjectAbort(ListAllocatedPeopleApi, config)
  );
};
...
export const ListJudgedPeopleApi = (request: ListJudgedPeopleApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<ListJudgedPeopleApi$$Response>>(
    '/v1/task/ListJudgedPeopleApi',
    request,
    InjectAbort(ListJudgedPeopleApi, config)
  );
};
...
export const TaskDocumentDetailsApi = (request: TaskDocumentDetailsApi$$Request, config?: AxiosRequestConfig) => {
  return axiosInstance.post<BaseServeResponse<TaskDocumentDetailsApi$$Response>>(
    '/v1/task/TaskDocumentDetailsApi',
    request,
    InjectAbort(TaskDocumentDetailsApi, config)
  );
};
...
/** ========================= **************** ExportTagPeopleApi ****************** ========================= */
/** 导出分级研析人员 请求参数 */
export interface ExportTagPeopleApi$$Request {}
/** 导出分级研析人员 响应参数*/
export interface ExportTagPeopleApi$$Response {}
/** 导出分级研析人员 */

export const ExportTagPeopleApi = (config: AppAxiosRequestConfig<ExportTagPeopleApi$$Request>) => {
  return axiosInstance.get<BaseServeResponse<ExportTagPeopleApi$$Response>>('/v1/ExportTagPeopleApi', InjectAbort(ExportTagPeopleApi, config));
};
...
export const AdminStatisticsExportApi = (config: AppAxiosRequestConfig<AdminStatisticsExportApi$$Request>) => {
  return axiosInstance.get<BaseServeResponse<AdminStatisticsExportApi$$Response>>(
    '/v1/task/AdminStatisticsExportApi',
    InjectAbort(AdminStatisticsExportApi, config)
  );
};
...
export const AuditorStatisticsExportApi = (config: AppAxiosRequestConfig<AuditorStatisticsExportApi$$Request>) => {
  return axiosInstance.get<BaseServeResponse<AuditorStatisticsExportApi$$Response>>(
    '/v1/task/AuditorStatisticsExportApi',
    InjectAbort(AuditorStatisticsExportApi, config)
  );
};
